...
description: Guide GitClaw-specific frontend patterns, component architecture, and UI/UX conventions. Use when implementing pages or components that follow GitClaw's existing design system.
---

# GitClaw Frontend Patterns
